  ...
  const mockData = [
    {
      ...
      "details": "Buscamos un desarrollador full stack con experiencia en React y Node.js para trabajar en proyectos innovadores. Requisitos: 3+ años de experiencia en desarrollo web. Conocimientos en React, Node.js y MongoDB. Experiencia con metodologías ágiles. Beneficios: Trabajo remoto. Seguro médico. Bonos por desempeño.",
    ...
    },
    {
      ...
      "details": "Se busca un ingeniero DevOps con experiencia en AWS, Docker y Kubernetes para optimizar nuestra infraestructura en la nube. Requisitos: Experiencia con AWS y herramientas de CI/CD. Conocimientos en contenedores y orquestación (Docker, Kubernetes). Manejo de infraestructura como código (Terraform, Ansible). Beneficios: Opción de trabajo híbrido. Seguro de vida y salud. Presupuesto anual para formación.",
    ...
    },
    {
      ...
      "details": "Estamos en búsqueda de un Analista de Datos para interpretar datos y generar informes estratégicos. Requisitos: Experiencia en SQL, Python y Power BI. Habilidad para análisis estadístico. Beneficios: Plan de carrera. Seguro de salud. Home office parcial.",
    ...
    },
    {
      ...
      "details": "Lidera estrategias de marketing digital para e-commerce y generación de leads. Requisitos: Experiencia en SEO, SEM y redes sociales. Manejo de plataformas de automatización de marketing. Beneficios: Oportunidad de crecimiento. Trabajo híbrido. Bonos por desempeño.",
    ...
    },
    {
      ...
      "details": "Buscamos un especialista en ciberseguridad para reforzar la seguridad de nuestros sistemas. Requisitos: Conocimientos en análisis de vulnerabilidades, pentesting y gestión de riesgos. Certificaciones en seguridad (CISSP, CEH). Beneficios: Plan de certificaciones. Seguro médico premium. Trabajo remoto parcial.",
  ...
  return (
    <section className="md:col-span-10 flex flex-col md:px-10 py-4 px-8 gap-8 max-h-fit">
      ...
      <form className="flex-1 flex max-h-fit items-stretch justify-center gap-4">
        <Input id="job" name="job" type="text" className="h-full" placeholder="Search jobs here..." />
